...
//        params = (getArguments().getSerializable(Constants.PARAMS) != null) ? (HashMap) getArguments().getSerializable(Constants.PARAMS) : new HashMap();
        ...
        if (getActivity() != null) {
            ...
            myAdapter1 = new MyExpandableListAdapter(mContext, groupArray, childArray);
            myAdapter2 = new MyExpandableListAdapter(mContext, groupArray2, childArray2);
...
//            读取本地图片
        ...
        View view = View.inflate(myActivity, R.layout.fragment_check_input,
                null);
    ...
    private void findView(final View view) {
        ...
        text_title1 = (TextView) view.findViewById(R.id.item_title1).findViewById(R.id.text_title);
        ...
        img_addSop2 = (ImageView) view.findViewById(R.id.item_title2).findViewById(R.id.img_add);
...
//        text_title3.setText(getResources().getString(R.string.item_title3));
        ...
        elv = (ExpandableListView) view.findViewById(R.id.elv1);
        ...
        elv2 = (ExpandableListView) view.findViewById(R.id.elv2);
//        elv2.setAdapter(myAdapter2);
        ...
        igv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                PicUtil picUtil = new PicUtil(mContext);
        ...
        uncheckedBtn = (Button) view.findViewById(R.id.unchecked_btn);
...
//            commitLayout.setVisibility(View.GONE);
        ...
        sfxyhfIv = (ImageView) view.findViewById(R.id.sfxyhf_iv);
        ...
        sfxycyIv = (ImageView) view.findViewById(R.id.sfxycy_iv);
        ...
        sfxyhfTv = (TextView) view.findViewById(R.id.sfxyhf_tv);
        ...
        sfxycyTv = (TextView) view.findViewById(R.id.sfxycy_tv);
        ...
        mouthTv = (TextView) view.findViewById(R.id.mouth);
...
//                ((ViewGroup) (((ViewGroup) datePicker.getChildAt(0)).getChildAt(0))).getChildAt(2).setVisibility(View.GONE);
        ...
        hzBtn = (Button) view.findViewById(R.id.hz_btn);
        ...
        ptrEt = (EditText) view.findViewById(R.id.ptjcr_et);
    }
...
//        }
    ...
    public void showNoteDialog() {
        View beizhu = inflater.inflate(R.layout.beizhu, null);
    ...
    public static void UploadPics(final ArrayList<PicBean> picList) {
        String url = "";
        if ("".equals(Constants.TYPE))
            url = Retrofit2Service.SAVE_PLAN_CHECK_CONTENT_PICTURE_TEMP;
        else
